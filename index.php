...
<div class="container">
    ...
    <div class="header">
        <div class="pull-right admin">管理员 <a href="?logout">登出</a></div>
        <h1>八戒图书管理</h1>
    </div>
    <hr>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline" role="form" action="" method="POST">
                ...
                </div><span class="item-douban">/</span>
            ...
            <?php
                ...
                foreach($data as $item){
                    ...
                    if(!empty($item["state"])){
                        ...
                        $list .= $borrow_name.'('.$item["update_time"].'借出) <a class="btn btn-default btn-sm book-return" href="?state='.$item["id"].'">还书</a>';
                    }else{
                        $list .= '空闲';
                    }
                    $list .= '</span>';
